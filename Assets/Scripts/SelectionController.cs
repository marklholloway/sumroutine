...
public class SelectionController: MonoBehaviour
{
    ...
    void OnSimpleDragAndDropEvent(DragAndDropCell.DropEventDescriptor desc)
    {
        ...
        SelectionController sourceSheet = desc.sourceCell.GetComponentInParent<SelectionController>();
        // Get control unit of destination cell
        SelectionController destinationSheet = desc.destinationCell.GetComponentInParent<SelectionController>();
